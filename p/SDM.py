...
# Determine if the application is a frozen executable (bundled)
if getattr(sys, 'frozen', False):
    ...
    # If it's not bundled, use the directory where the script is located
    application_path = os.path.dirname(os.path.abspath(__file__))

# Use application_path to build the absolute path to your assets
bg_image_path = os.path.join(application_path, 'bg.png')
ship_image_path = os.path.join(application_path, 'ship.png')
star_image_path = os.path.join(application_path, 'star.png')
mm_bg_image_path = os.path.join(application_path, 'mm bg.png')
bg_still_image_path = os.path.join(application_path, 'bg still.jpeg')
gta_sound_path = os.path.join(application_path, 'gta.mp3')
resilience_sound_path = os.path.join(application_path, 'Resilience.ogg')
music_sound_path = os.path.join(application_path, 'music.ogg')

# Load the death sound effect
GO_sound = pygame.mixer.Sound(gta_sound_path)
...
BACKGROUND = pygame.transform.scale(pygame.image.load(bg_image_path), (WIDTH, HEIGHT))
PLAYER_IMAGE = pygame.transform.scale(pygame.image.load(ship_image_path), (40, 60))
STAR_IMAGE = pygame.transform.scale(pygame.image.load(star_image_path), (25, 50))
